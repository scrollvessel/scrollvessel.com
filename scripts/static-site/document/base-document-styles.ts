export class BaseDocumentStyles {
  constructor(private readonly extraStyles: string = '') {}
  ...
  render(): string {
    return `<style>
      ...
      * { box-sizing: border-box; }
      ...
      .child-category-list a { grid-template-columns: minmax(0, 1fr) auto; gap: 6px 16px; align-items: baseline; }
      ...
      .child-category-list a > span:last-child { min-width: 4em; text-align: right; white-space: nowrap; }
