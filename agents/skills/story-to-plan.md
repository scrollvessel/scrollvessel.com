...
当 `story.md`、`tests.md` 已准备好，且 UI story 已有 `ui.md` 或 `ui/` 产物，需要生成可执行实现计划。

## 输入

- `story.md`。
- `tests.md`。
- UI story 需要 `ui.md` 和相关 UI 产物；非 UI story 可省略，但必须在计划中说明原因。
...
2. 若没有 UI 产物，判断该 story 是否为非 UI story；若是，在计划中说明“不需要 UI 产物”的原因。
